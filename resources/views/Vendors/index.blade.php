    ...
    <div class="modal-dialog modal-full-width">
        <div class="modal-content">
            <div class="modal-header">
                <h4 class="modal-title" id="myLargeModalLabel">NUEVO PROVEEDOR</h4>
                <button type="button" class="close" data-dismiss="modal" aria-hidden="true">×</button>
            </div>
            <div class="modal-body">
                <form method="post" action="{{ route('Vendors.store') }}" enctype="multipart/form-data" class="needs-validation" novalidate>
                    @csrf
                    <div class="row">
                        <div class="col-4">
                            <div class="card-box ">
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-4">
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control" placeholder="" name="interbankaccount"  autocomplete="off">                                            
                                    </div>
                                </div> <!-- end col -->                                    
                            </div>                                                                  
                            <div class="row">
    ...
    <div class="col-xs-12 col-lg-8">
        <div class="card">
            <div class="card-header py-3 text-white" style="background-color: #62B22F;">
                ...
                <h5 class="card-title mb-0 text-white">PROVEEDORES</h5>
            </div>
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        <a data-toggle="modal" data-target="#modal_show" onclick="btn_show({{$column->id}})" id="show{{$column->id}}" data-status="{{route('Vendors.show',$column->id)}}" href="javascript:void(0);" class="action-icon" title="Ver" data-plugin="tippy" data-tippy-placement="top" > <i class="mdi mdi-eye text-primary"></i></a>
                                        <a data-toggle="modal" data-target="#modal_edit" onclick="btn_edit({{$column->id}})" id="edit{{$column->id}}" data-status="{{route('Vendors.edit',$column->id)}}" href="javascript:void(0);" class="action-icon btn-edit" title="Editar" data-plugin="tippy" data-tippy-placement="top"> <i class="mdi mdi-square-edit-outline text-warning"></i></a>
                                        ...
                                        <form method="POST" id="form{{ $c }}" action="{{route('Vendors.destroy',$column->id)}}">
                                            @csrf
                                            @method('delete')
