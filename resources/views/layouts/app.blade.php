...
<html lang="en">
    ...
    <body class="loading">
        ...
        <div id="wrapper">
            ...
            <!-- Topbar Start -->
            <div class="navbar-custom" style="background-color:#62B22F;">
                                ...
                                <div class="app-search-box dropdown">
                                    ...
                                    <div class="dropdown-menu dropdown-lg" id="search-dropdown">
                                        ...
                                        <div class="notification-list">
                                            ...
                                            <a href="javascript:void(0);" class="dropdown-item notify-item">
                                                <div class="media">
                                                    <img class="d-flex mr-2 rounded-circle" src="{{ asset('images/users/user-2.jpg') }}" alt="Generic placeholder image" height="32">
                                            ...
                                            <a href="javascript:void(0);" class="dropdown-item notify-item">
                                                <div class="media">
                                                    <img class="d-flex mr-2 rounded-circle" src="{{ asset('images/users/user-5.jpg') }}" alt="Generic placeholder image" height="32">
                                                    <div class="media-body">
                                ...
                                <div class="noti-scroll" data-simplebar>
                                    ...
                                    <a href="javascript:void(0);" class="dropdown-item notify-item active">
                                        ...
                                        <p class="text-muted mb-0 user-msg">
                                            <small>Compra 143 aprobada</small>
                                        </p>
                                    </a>
                                    ...
                                    <a href="javascript:void(0);" class="dropdown-item notify-item">
                                        ...
                                        <p class="text-muted mb-0 user-msg">
                                            <small>Realizar mantenimiento al vehículo 432</small>
                                        </p>
                                    </a>
                                    ...
                                    <a href="javascript:void(0);" class="dropdown-item notify-item">
                                        ...
                                        <p class="notify-details">Nuevo empleado registrado
                                    ...
                                    <a href="javascript:void(0);" class="dropdown-item notify-item">
                                        ...
                                        <p class="notify-details">Realizar visita al cliente...
                                            <small class="text-muted">Hace 1 horas</small>
                                        </p>
                                    </a>
                                    ...
                                    <a href="javascript:void(0);" class="dropdown-item notify-item">
                                        ...
                                        <p class="notify-details">Requisición
                                            <b>Aprobada</b>
                ...
                <div class="h-100" data-simplebar>
                    ...
                    <div id="sidebar-menu">
                        ...
                        <ul id="side-menu">
                            ...
                            <li>
                                <a href="#FormatsRH" data-toggle="collapse">
                                    <i class="mdi mdi-clipboard-text"></i>
                                    <span> Formatos </span>
                                    <span class="menu-arrow"></span>
                                </a>
                                <div class="collapse" id="FormatsRH">
                                    <ul class="nav-second-level">
                                        <li>
                                            <a href="{{ url('StaffRequest') }}"><i class="mdi mdi-card-account-details"></i> Solicitud de personal</a>
                                        </li>
                                        <li>
                                            <a href="{{ url('JobProfile') }}"><i class="mdi mdi-card-account-details-star"></i> Perfil del puesto</a>
                                        </li>
                                        <li>
                                            <a href="#.html"><i class="mdi mdi-clipboard-account"></i> Checklist de personal</a>
                                        </li>
                                        <li>
                                            <a href="#.html"><i class="mdi mdi-clipboard-account"></i> Evaluación de personal</a>
                                        </li>
                                        <li>
                                            <a href="#.html"><i class="mdi mdi-account-details"></i> Inducción</a>
                                        </li>
                                        <li>
                                            <a href="#.html"><i class="mdi mdi-contacts"></i> Capacitación</a>
                                        </li>
                                    </ul>
                                </div>
                            </li>
                            <li class="menu-title">Operativa</li>
                            <li>
                            ...
                            <li>
                                <a href="#FormatsShopping" data-toggle="collapse">
                                    <i class="mdi mdi-clipboard-text"></i>
                                    <span> Formatos </span>
                                    <span class="menu-arrow"></span>
                                </a>
                                <div class="collapse" id="FormatsShopping">
                                    <ul class="nav-second-level">
                                        <li>
                                            <a href="{{ url('Requisitions') }}"><i class="mdi mdi-card-account-details"></i> Requisiciones</a>
                                        </li>
                                        <li>
                                            <a href="{{ url('QuotationsShopping') }}"><i class="mdi mdi-card-account-details-star"></i> Cotizaciones</a>
                                        </li>
                                        <li>
                                            <a href="{{ url('PurchaseOrders') }}"><i class="mdi mdi-clipboard-account"></i> Orden de Compras</a>
                                        </li>
                                        <li>
                                            <a href="{{ url('Bills') }}"><i class="mdi mdi-clipboard-account"></i> Facturas</a>
                                        </li>
                                        <li>
                                            <a href="{{ url('ExitOrders') }}"><i class="mdi mdi-account-details"></i> Orden de Salida</a>
                                        </li>
                                    </ul>
                                </div>
                            </li>
                            ...
                            <li>
                                <a href="{{ url('UnitReview') }}">
                                    <i class="mdi mdi-car-arrow-right"></i>
                                    <span> Revisión de la unidad </span>
                                </a>
                            </li>  
                            <li>
            ...
            <div class="content-page">
                            ...
                            <div class="page-title-box">
                                <div class="page-title-right">
                                    <ol class="breadcrumb m-0">
                                        <li class="breadcrumb-item"><a href="javascript: void(0);">@yield('department')</a></li>
                ...
                <footer class="footer">
                    <div class="container-fluid">
                        <div class="row">
                            <div class="col-md-6">
                                 <script>document.write(new Date().getFullYear())</script> &copy; by <a href="wwww.stigmacode.com">StigmaCode.com</a> 
                            </div>
                            <div class="col-md-6">
