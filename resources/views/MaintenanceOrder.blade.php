        ...
        <div class="modal-dialog modal-lg">
            <div class="modal-content">
                <div class="modal-header">
                    <h4 class="modal-title" id="myLargeModalLabel">Orden de matenimiento</h4>
                    <button type="button" class="close" data-dismiss="modal" aria-hidden="true">×</button>
                </div>
                <div class="modal-body">
                    <div class="row">                                           
                        <div class="col-12">
                            <embed src="{{ asset('files/orden_mantenimiento.pdf') }}" width="100%" height="1000px">
                        </div>
                    </div>
                </div>
            </div><!-- /.modal-content -->
                        ...
                        <div class="row">
                            <div class="col-lg-8">
                                <div class="card">
                                    <div class="card-header" style="background-color: #62B22F; color: white;">Orden de mantenmiento</div>
                                    <div class="card-body">
                                        <div class="row mb-2">
                                            <div class="col-sm-4">
                                            ...
                                            <div class="col-sm-8">
                                                <div class="text-sm-right">
                                                   <!--<button type="button" class="btn btn-success waves-effect waves-light mb-2 mr-1"><i class="mdi mdi-cog"></i></button>-->
                                                    <button type="button" class="btn btn-danger waves-effect waves-light mb-2" data-toggle="modal" data-target="#bs-example-modal-lg">Nueva Orden</button>
                                                </div>
                                            </div><!-- end col-->
                                        </div>
                                        <!--  Modal content for the Large example -->
                                        <div class="modal fade" id="bs-example-modal-lg" tabindex="-1" role="dialog" aria-labelledby="myLargeModalLabel" aria-hidden="true">
                                            <div class="modal-dialog modal-lg">
                                                <div class="modal-content">
                                                    <div class="modal-header">
                                                        <h4 class="modal-title" id="myLargeModalLabel">Orden de mantenimiento</h4>
                                                        <button type="button" class="close" data-dismiss="modal" aria-hidden="true">×</button>
                                                    </div>
                                                    <div class="modal-body">
                                                        <form class="form-row"> 
                                                            ...
                                                            <div class="form-group col-md-3 mb-4">
                                                                <label for="inputEmail4">No. REPORTE</label>
                                                                <input type="email" class="form-control rounded" id="" placeholder="">
                                                            </div>
                                                            <div class="form-group col-md-3 mb-4">
                                                            ...
                                                            <div class="form-group col-md-3 mb-4">
                                                                <label for="inputEmail4">HRS MTTO PREVENTIVO</label>
                                                                <input type="email" class="form-control rounded" id="" placeholder="">
                                                            </div>  
                                                            <div class="form-group col-md-3 mb-4">
                                                                <label for="inputEmail4">HRS MTTO ACTUALES</label>
                                                                <input type="email" class="form-control rounded" id="" placeholder="">
                                                            </div>   
                                                            <div class="form-group col-md-12 mb-4">
                                                                <label for="inputEmail4">DESCRIPCIÓN</label>
                                                                <textarea type="email" rows="5" class="form-control rounded" id="" placeholder=""></textarea>
                                                            </div>  
                                                            <div class="form-group col-md-3 mb-4">
                                                                <label for="inputEmail4">PTOS.</label>
                                                                <input type="email" class="form-control rounded" id="" placeholder="">
                                                            </div>  
                                                            <div class="form-group col-md-3 mb-4">
                                                                <label for="inputEmail4">NO. MEC</label>
                                                                <input type="email" class="form-control rounded" id="" placeholder="">
                                                            </div> 
                                                            <div class="form-group col-md-3 mb-4">
                                                                <label for="inputEmail4">HRS. NORMALES</label>
                                                                <input type="email" class="form-control rounded" id="" placeholder="">
                                                            </div>
                                                            <div class="form-group col-md-3 mb-4">
                                                                <label for="inputEmail4">HRS. EXTRAS</label>
                                                                <input type="email" class="form-control rounded" id="" placeholder="">
                                                            </div>  
                                                            <div class="form-group col-md-3 mb-4">
                                            ...
                                            <table class="table table-centered table-nowrap table-hover mb-0">
                                                ...
                                                <tbody>
                                                    <tr>
                                                        ...
                                                        <td>23/11/2021</td>  
                                                        <td>Requiere cambio de aceite</td>                                                      
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>25/11/2021</td>  
                                                        <td>Urgente cambio de llanta para continuar ruta</td>                                                         
                                                        <td class="text-center"><span class="badge badge-success text-white">Correcto</span></td>
                                                        <td><a  href="" data-toggle="modal" data-target="#bs-example-modal-lg2"><i class="mdi h5 mr-2 mdi-file-document-outline" style="font-size:30px"></i></a></td>                                                                                               
                                                        <td>
                                                            <a href="javascript:void(0);" class="action-icon"> <i class="mdi mdi-square-edit-outline"></i></a>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>23/11/2021</td>  
                                                        <td>Revisión de motor</td>                                                         
                                                        <td class="text-center"><span class="badge badge-danger text-white">Revisar</span></td>
                                                        <td><a href="MaintenanceOrderPDF.html"><i class="mdi h5 mr-2 mdi-file-document-outline" style="font-size:30px"></i></a></td>                                                                                              
                                                        <td>
                                                            <a href="javascript:void(0);" class="action-icon"> <i class="mdi mdi-square-edit-outline"></i></a>
                                                            <a href="javascript:void(0);" class="action-icon"> <i class="mdi mdi-delete"></i></a>
                                                        </td>
                            ...
                            <div class="col-lg-4">
                                <div class="card">
                                    ...
                                    <div class="card-body">
                                        ...
                                        <div class="row">
                                            <div class="col-12">
                                                <h4 class="font-13 text-muted text-uppercase">MTTO:</h4>
                                            </div>
                                            <div class="col-12">
                                                <h4 class="font-13 text-muted text-uppercase mb-1">DESCRIPCIÓN:</h4>
                                                 
                                            </div>
                                            <div class="col-12">
                                                <h4 class="font-13 text-muted text-uppercase mb-1">PTOS:</h4>
                                             
                                            </div>
                                            <div class="col-12">
                                                <h4 class="font-13 text-muted text-uppercase mb-1">NO. MEC:</h4>
                                             
                                            </div>
                                            <div class="col-12">
                                                <h4 class="font-13 text-muted text-uppercase mb-1">HRS. NORMALES:</h4>
                                             
                                            </div>
                                            <div class="col-12">
                                                <h4 class="font-13 text-muted text-uppercase mb-1">HRS. EXTRAS:</h4>
                                             
                                            </div>
                                            <div class="col-12">
                                                <h4 class="font-13 text-muted text-uppercase mb-1">TIEMPO:</h4>
                                             
                                            </div>
                                            <div class="col-12">
                                                <h4 class="font-13 text-muted text-uppercase mb-1">OPERADOR:</h4>
                                             
                                            </div>
                                            <div class="col-12">
                                                <h4 class="font-13 text-muted text-uppercase mb-1">JEFE DE TURNO:</h4>
                                             
                                            </div>
                                            <div class="col-12">
                                                <h4 class="font-13 text-muted text-uppercase mb-1">ALMACENISTA:</h4>
