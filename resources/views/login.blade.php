                    ...
                    <div class="card-body">
                        ...
                        <form action="#">
                            <div class="form-group">
                                ...
                                <input class="form-control" type="email" id="emailaddress" required="" placeholder="Ingresa tu correo electrónico" value="administrador@sos.com.mx">
                            </div>
                            <div class="form-group">
                                <a href="auth-recoverpw-2.html" class="text-muted float-right"><small>¿Olvidaste tu contraseña?</small></a>
                                <label for="password">Contraseña</label>
                                <div class="input-group input-group-merge">
                                    <input type="password" id="password" class="form-control" placeholder="Ingresa tu contraseña" value="admin1234">
                            ...
                            <div class="form-group mb-0 text-center">
                                <a  href="{{ url('Home') }}" href="javascript: void(0);"  class="btn btn-block btn-sm btn-success waves-effect waves-light">Iniciar sesión</a>                      
                            </div>
                            <!-- social-->
