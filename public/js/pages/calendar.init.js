    ...
    (e.prototype.onEventClick = function (e) {
        ...
        (e.prototype.onSelect = function (e) {
            this.$formEvent[0].reset(),
                ...
                this.$modalTitle.text("Nueva Cita"),
                this.$modal.modal({ backdrop: "static" }),
        ...
        (e.prototype.init = function () {
            ...
            var t = [
                    {
                        title: "ALL IN SERVICE S.A. DE C.V",
                        start: new Date(l.now() + 158e6),
                        end: new Date(l.now() + 338e6),
                        className: "bg-warning",
                    },
                    {
                        title: "BAKER HUGHES OPERATIONS MEXICO S.A. DE C.V.",
                        start: e,
                        end: e,
                        className: "bg-success",
                    },
                    {
                        title: "HOTEL HACIENDA REAL",
                        start: new Date(l.now() + 168e6),
                        className: "bg-info",
                    },
                    {
                        title: "RESTAURANTE IGUANA BEACH",
